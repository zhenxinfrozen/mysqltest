...
<?php
		...
		while(list($id,$name,$age,$about_she,$pic)=mysql_fetch_row($result)){
			echo '<div style="background:blue;width:400px;height:800px;margin:5px; overflow:hidden; float:left; ">';
...
<?php
		...
		echo '<div style="background:#6c0;width:100%;overflow:hidden;">' ;
			...
			echo '<div style="background:pink;width:300px;height:550px;margin:5px; overflow:hidden; float:left; ">';
			...
			echo '<div style="width:100%; text-align:center;"> <img src="'.$pic.'" width=300></div>';
			echo '</div>';
